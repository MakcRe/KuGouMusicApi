...
import { cryptoMd5, cryptoSha1 } from '../util/crypto';
...
const ticket = (accessToken: string) =>
  axios({ url: 'https://api.weixin.qq.com/cgi-bin/ticket/getticket', params: { access_token: accessToken, type: 2 } });
