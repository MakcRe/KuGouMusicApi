...
**调用例子：** `/user/purchased/songs` `/user/purchased/songs?page=1&pagesize=10`

### 获取已购专辑

说明：登录后调用此接口，可以获取用户已购买的专辑列表
...
**调用例子：** `/user/purchased/albums` `/user/purchased/albums?page=1&pagesize=10`
